...
var SearchBox = function(editor, range, showReplaceForm) {
    ...
    dom.buildDom(["div", {class:"ace_search right"},
        ...
        ["div", {class: "ace_search_form"},
            ["input", {class: "ace_search_field", placeholder: "请输入搜索关键词", spellcheck: "false"}],
            ["span", {action: "findPrev", class: "ace_searchbtn prev"}, "\u200b"],
            ["span", {action: "findNext", class: "ace_searchbtn next"}, "\u200b"],
            ["span", {action: "findAll", class: "ace_searchbtn", title: "Alt-Enter"}, "查找"]
        ],
        ["div", {class: "ace_replace_form"},
            ["input", {class: "ace_search_field", placeholder: "替换内容", spellcheck: "false"}],
            ["span", {action: "replaceAndFindNext", class: "ace_searchbtn"}, "替换"],
            ["span", {action: "replaceAll", class: "ace_searchbtn"}, "全部替换"]
        ],
